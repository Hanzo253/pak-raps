  ...
  return (
    <div className="songs">
      ...
      <section className="list-section container">
        ...
        {!showSongList && (
          <Comments songs={songs} index={songsIndex} comments={comments} />
        )}
      </section>
      {/* {!showSongList && (
        <AudioPlayer
